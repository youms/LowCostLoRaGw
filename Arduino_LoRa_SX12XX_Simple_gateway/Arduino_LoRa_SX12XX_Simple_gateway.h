...
const uint32_t Frequency = 868100000;           //frequency of transmissions in hertz
const uint32_t Offset = 0;                      //offset frequency for calibration purposes
uint8_t Bandwidth = LORA_BW_125;          			//LoRa bandwidth
uint8_t SpreadingFactor = LORA_SF7;       			//LoRa spreading factor
...
#endif
//*******
#define DIO1 6                                 //DIO1 pin on LoRa device, normally not used so set to -1 
#define DIO2 7                                 //DIO2 pin on LoRa device, normally not used so set to -1
