...
void do_send(osjob_t* j) {
    ...
    Serial.print(F("% MQ9:")); Serial.print(mq9_adc);
...
void setup() {
    Serial.begin(9600);
    Serial.println(F("DHT22 + MQ9 + Dust | ABP | Single-CH 868.1 MHz"));

    dht22_Init();
    mq9_Init();     // longest warmup — 60s
    dust_Init();
