...
// 10-byte positional payload: temp | hum | MQ2 ADC | MQ2 Rs/R0 | dust ADC
...
void setup() {
    Serial.begin(9600);
    Serial.println(F("DHT22 + MQ2 + Dust | ABP | Single-CH 868.1 MHz"));
