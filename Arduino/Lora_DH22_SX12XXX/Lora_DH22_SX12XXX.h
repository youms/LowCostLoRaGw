////////////////////////////////////////////////////////////////
// DHT22 Temperature & Humidity Sensor with LoRa - Header File
...
//NOTE: DHT22 is connected to pin 3, so pin 4 is free for LoRa NRESET
#define NSS 10                                  //select pin on LoRa device
#define NRESET 4                                //reset pin on LoRa device (DHT22 moved to pin 3)
...
// DHT22 Sensor pin definition
#define DHT22_PIN 3                             // DHT22 data pin (moved from pin 4 to avoid LoRa NRESET conflict)

/*
 * Enhanced DHT22 LoRa Sensor Features:
 * 
 * LOW POWER FEATURES:
 ...
 * - DHT22 power management (optional external power control)
 * 
 ...
 * - Error handling for sensor disconnection/read failures
 * - CRC calculation and verification
 * - DHT22 checksum validation
 * 
 * PROFESSIONAL FEATURES:
 * - Gateway-compatible data format (\!TC/temp/HU/humidity)
 ...
 * - Data pin: Arduino Pin 3 (DHT22_PIN)
 ...
 * - node_addr: Change for each sensor node (default: 9)
 ...
 *   * DHT_POWER_PIN: External power control for DHT22
 */