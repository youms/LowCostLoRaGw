...
void do_send(osjob_t* j){
    ...
    if (LMIC.opmode & OP_TXRXPEND) {
        ...
        // Add battery voltage or other sensor data if needed
        // mydata[2] = ...;
        // mydata[3] = ...;
        
        // Prepare upstream data transmission at the next possible time
        LMIC_setTxData2(1, mydata, 2, 0); // Using port 1, 2 bytes of data, no ack
        
        Serial.print(F("Packet queued - Temperature: "));
        Serial.print(tempC);
        Serial.print(F(" °C ("));
...
void setup() {
    ...
    Serial.begin(115200);
    Serial.println(F("Starting Temperature Sensor with MCCI LMIC & TTN"));

    // Initialize temperature sensor
    sensors.begin();
    Serial.print(F("Temperature sensor devices: "));
